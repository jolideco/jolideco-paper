...
% Abstract with filler text
    ...
    be solved for fluorescence microscopy or others...

    We assume non-blind deconvolution, so the there is prior information of the PSF
    ...
    Shown to work for e.g. deconvolution of Galaxy images SDSS \todo{reference?} and post-processing of regularised RL results \todo{Starck et al.}
    ...
    As a background model we included the latest Galactic diffuse emission model \texttt{gll\_iem\_v07.fits}.
    ...
    Figure~\ref{fig:example-fermi-lat} shows the result. \jolideco clearly improves the noise level as well as
    angular resolution. It reveals mophological details consistent with the HESS measurement.
