...
% Abstract with filler text
    ...
    \subsubswction{Comparing Instruments}
    ...
    \begin{equation}
        ...
        \sigma = \frac{N_{\mathrm{Counts}} - N_{\mathrm{Pred}}} {\sqrt{N_{\mathrm{Pred}}}}
    \end{equation}
    ...
    Figure~\ref{fig:example-fermi-lat} shows the result. \jolideco clearly improves the noise level as well as angular resolution. It reveals mophological details consistent with the HESS measurement \todo{Add HESS image or erosita for comparison? But this is not an analysis...}
    The calibration of the predicted counts finds different background model norms and positional shifts in order of \todo{add value} for the different event classes. This way it corrects for systematic errors in the reconstruction of the position. As a check we compute a map of residuals based on  predicted counts, also 
